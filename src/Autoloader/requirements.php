...
function resursBankHasNoEcom(): void
{
    add_action('admin_notices', static function (): void {
        ...
        echo '<p><strong>ECom2:</strong> Dependencies are missing from the plugin structure. ' .
...
function resursBankHasOldPhp(): void
{
    add_action('admin_notices', static function (): void {
        echo '<div class="notice notice-error is-dismissible">';
        echo '<p><strong>ECom2:</strong> Your PHP version (' . PHP_VERSION . ') is too old. This plugin requires ' .
