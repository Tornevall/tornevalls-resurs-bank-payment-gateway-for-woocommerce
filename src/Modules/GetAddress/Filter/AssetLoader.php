...
class AssetLoader
{
    ...
    public static function enqueueCostListJs(): void
    {
        ...
        wp_add_inline_script('resursbankabpaygw-costlist-js', $costListJs);
    }
    ...
    public static function enqueueReadMoreJs(): void
    {
        ...
        // JavaScript is generated by trusted SDK and passed to wp_add_inline_script(),
        // which automatically places it in a <script> tag context where HTML escaping
        // would break the code. The content is not user-supplied and is safe.
        wp_add_inline_script(
            'resursbankabpaygw-rm-readmore-js',
