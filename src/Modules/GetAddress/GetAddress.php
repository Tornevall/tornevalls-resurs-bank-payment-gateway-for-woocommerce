...
namespace Resursbankabpayments\Woocommerce\Modules\GetAddress;
...
class GetAddress
{
    ...
    public static function init(): void
    {
        ...
        add_filter(
            'the_content',
            'Resursbankabpayments\Woocommerce\Modules\GetAddress\Filter\Blocks\InjectFetchAddressWidget::exec'
        );

        // Inject Get Address widget in legacy checkout.
        add_filter(
            'woocommerce_before_checkout_form',
            'Resursbankabpayments\Woocommerce\Modules\GetAddress\Filter\Legacy\InjectFetchAddressWidget::exec'
        );
    }
