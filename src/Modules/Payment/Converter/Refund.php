...
use Resursbank\Woocommerce\Modules\Payment\Converter\Refund\Product;
...
class Refund
{
    ...
    public static function getOrderLines(
        ...
        // Add an order line for the shipping credit if there is any.
        if (Shipping::hasShippingCredit(order: $order)) {
