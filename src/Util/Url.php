...
class Url
{
    ...
    public static function getResourceUrl(
        ...
        return plugin_dir_url(
            RESURSBANKABPAYMENTS_MODULE_DIR_NAME . "/src/Modules/$module/resources/$type->value/" .
    ...
    public static function getAssetUrl(
        ...
        return plugin_dir_url(
            file: RESURSBANKABPAYMENTS_MODULE_DIR_NAME . '/assets/js/dist/' .
                str_replace(search: '/', replace: '', subject: $file)
        ) . $file;
    }
    ...
    public static function getEcomUrl(
        ...
        return self::getUrl(
            path: RESURSBANKABPAYMENTS_MODULE_DIR_NAME . "/vendor/ecom/$path"
        );
    }
