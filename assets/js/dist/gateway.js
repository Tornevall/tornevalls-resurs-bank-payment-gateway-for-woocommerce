...
const settings = (0,_woocommerce_settings__WEBPACK_IMPORTED_MODULE_4__.getSetting)('resursbank_data', {});
(() => {
  ...
  settings.payment_methods.forEach(method => {
    ...
    const calculateCartTotal = cartData => {
      return parseInt(cartData.totals.total_price, 10) / Math.pow(10, cartData.totals.currency_minor_unit);
    };
     ...
     */
    const updateIframeSource = (iframe, cartTotal) => {
     ...
     */
    const Content = () => {
      const cartData = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)(_woocommerce_block_data__WEBPACK_IMPORTED_MODULE_2__.CART_STORE_KEY).getCartData();
      const cartTotal = calculateCartTotal(cartData);
      react__WEBPACK_IMPORTED_MODULE_0___default().useEffect(() => {
        const iframe = document.querySelector('iframe.rb-rm-iframe');
        if (iframe) {
    ...
    const Label = props => {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        className: "rb-payment-method-title",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(PaymentMethodLabel, {
          text: label
    ...
    (0,_woocommerce_blocks_registry__WEBPACK_IMPORTED_MODULE_3__.registerPaymentMethod)({
      ...
      canMakePayment: data => {
        ...
        if (data.billingAddress.company !== '' && !method.enabled_for_legal_customer || data.billingAddress.company === '' && !method.enabled_for_natural_customer) {
          return false;
        }
        ...
        if (cart_total < method.min_purchase_limit || cart_total > method.max_purchase_limit) {
          return false;
        }
